...
class MotherBoard {
    string mark{};
    string model{};
    PCI pci{"PCI-X"}; // Композиция
    CPU cpu{}; //Агрегация
    Video_Card videocard{}; //Агрегация
public:
    MotherBoard() = default;
...
private: 
    string form{};
    MotherBoard motherboard{}; //Агрегация
    PowerSupply powersupply{}; //Агрегация
public:
...
int main()
{
    ...
    frame frame("ITX", motherboard, power);
    cout << frame;
